...
export default function WeatherAlerts({ currentData }: { currentData: CurrentWeather | null }) {
  ...
  return (
    <Card>
      ...
      <CardContent>
        ...
        {permission === 'granted' && alerts.length === 0 && (
          <p className="text-center text-muted-foreground py-4">No alerts set. Click 'Add Alert' to create one.</p>
        )}
        {alerts.length > 0 && (
